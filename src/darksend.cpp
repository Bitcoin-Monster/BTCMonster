...
{
    if(fLiteMode) return; // ignore all Bitcoin Monster related functionality
...
/*
    ...
    allow endless transaction that would bloat Bitcoin Monster and make it unusable. To
