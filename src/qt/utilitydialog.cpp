    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Bitcoin Monster Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Bitcoin Monster Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  bitcoinmonster-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Bitcoin Monster in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 MON, 0.1 MON, 1 MON and 10 MON -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://www.bitcoinmonster.com\">www.bitcoinmonster.com</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Bitcoin Monster Core is shutting down...") + "<br /><br />" +
