    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("BitcoinMonster Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About BitcoinMonster Core"));
...
All the BitcoinMonster in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("BitcoinMonster Core is shutting down...") + "<br /><br />" +
