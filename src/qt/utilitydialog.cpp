    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Banq Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Banq Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  banq-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Banq in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 BANQ, 0.1 BANQ, 1 BANQ and 10 BANQ -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Banq Core is shutting down...") + "<br /><br />" +
