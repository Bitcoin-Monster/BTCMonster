    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("BitcoinMonster Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BitcoinMonster address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About BitcoinMonster Core"), this);
    aboutAction->setStatusTip(tr("Show information about BitcoinMonster Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BitcoinMonster Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BitcoinMonster addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BitcoinMonster addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the BitcoinMonster Core help message to get a list with possible BitcoinMonster Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("BitcoinMonster Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BitcoinMonster network", "", count));
}
...
{
    QString strTitle = tr("BitcoinMonster Core"); // default title
    ...
    // Append title to "BitcoinMonster Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
