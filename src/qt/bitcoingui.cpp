    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Banq Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Banq address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and banq: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Banq Core"), this);
    aboutAction->setStatusTip(tr("Show information about Banq Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Banq Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Banq addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Banq addresses"));
    ...
    openAction->setStatusTip(tr("Open a banq: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Banq Core help message to get a list with possible Banq Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Banq Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Banq network", "", count));
}
...
{
    QString strTitle = tr("Banq Core"); // default title
