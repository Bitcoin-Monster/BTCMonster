...
<context>
    ...
    <message>
        ...
        <translation>Съобщението което беше прикрепено към bitcoinmonster: URI ще бъде запазено с транзакцията за ваше сведение. Забележка: Това съобщение няма да бъде изпратено през Coin2Fly мрежата.</translation>
    </message>
    <message>
