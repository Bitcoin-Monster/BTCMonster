...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"banqaddress\"\n"
            "\nReturn information about the given bitcoinmonster address.\n"
            "\nArguments:\n"
            "1. \"banqaddress\"     (string, required) The bitcoinmonster address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,       (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"banqaddress\", (string) The bitcoinmonster address validated\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"banqaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"banqaddress\"  (string, required) The bitcoinmonster address to use for the signature.\n"
