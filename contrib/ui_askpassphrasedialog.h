...
public:
    ...
    void setupUi(QDialog *AskPassphraseDialog)
    {
        ...
        mixingOnlyCheckBox->setObjectName(QString::fromUtf8("mixingOnlyCheckBox"));
    ...
    void retranslateUi(QDialog *AskPassphraseDialog)
    {
        ...
        mixingOnlyCheckBox->setToolTip(QApplication::translate("AskPassphraseDialog", "Serves to disable the trivial sendmoney when OS account compromised. Provides no real security.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        mixingOnlyCheckBox->setText(QApplication::translate("AskPassphraseDialog", "Only for mixing via PrivateSend", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
