...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        labelBalance->setText(QString::fromUtf8("123.456 MON"));
...
#ifndef QT_NO_TOOLTIP
        checkBoxMinimumFee->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks.<br />But be aware that this can end up in a never confirming transaction once there is more demand for bitcoinmonster transactions than the network can process.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        checkBoxMinimumFee->setText(QString());
#ifndef QT_NO_TOOLTIP
        labelMinFeeWarning->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks.<br />But be aware that this can end up in a never confirming transaction once there is more demand for bitcoinmonster transactions than the network can process.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
