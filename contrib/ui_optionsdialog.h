...
public:
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        showMasternodesTab->setObjectName(QString::fromUtf8("showMasternodesTab"));

        verticalLayout_2->addWidget(showMasternodesTab);

        showAdvancedPSUI = new QCheckBox(groupBox);
        showAdvancedPSUI->setObjectName(QString::fromUtf8("showAdvancedPSUI"));

        verticalLayout_2->addWidget(showAdvancedPSUI);

        lowKeysWarning = new QCheckBox(groupBox);
        lowKeysWarning->setObjectName(QString::fromUtf8("lowKeysWarning"));

        verticalLayout_2->addWidget(lowKeysWarning);

        privateSendMultiSession = new QCheckBox(groupBox);
        privateSendMultiSession->setObjectName(QString::fromUtf8("privateSendMultiSession"));
        ...
        horizontalLayout_4_Wallet->setObjectName(QString::fromUtf8("horizontalLayout_4_Wallet"));
        ...
        privateSendRounds->setObjectName(QString::fromUtf8("privateSendRounds"));
        ...
        privateSendAmount->setObjectName(QString::fromUtf8("privateSendAmount"));
        ...
        horizontalLayout_5_Display->setObjectName(QString::fromUtf8("horizontalLayout_5_Display"));
...
#ifndef QT_NO_TOOLTIP
        bitcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start Bitcoin Monster Core after logging in to the system.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        bitcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start Bitcoin Monster Core on system login", 0, QApplication::UnicodeUTF8));
...
#ifndef QT_NO_TOOLTIP
        showMasternodesTab->setToolTip(QApplication::translate("OptionsDialog", "Show additional tab listing all your masternodes in first sub-tab<br/>and all masternodes on the network in second sub-tab.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        showMasternodesTab->setText(QApplication::translate("OptionsDialog", "Show Masternodes Tab", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        showAdvancedPSUI->setToolTip(QApplication::translate("OptionsDialog", "Show additional information and buttons for PrivateSend on overview screen.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        showAdvancedPSUI->setText(QApplication::translate("OptionsDialog", "Enable advanced PrivateSend interface", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        lowKeysWarning->setToolTip(QApplication::translate("OptionsDialog", "Show warning dialog when PrivateSend detects that wallet has very low number of keys left.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        lowKeysWarning->setText(QApplication::translate("OptionsDialog", "Warn if PrivateSend is running out of keys", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        privateSendMultiSession->setToolTip(QApplication::translate("OptionsDialog", "Whether to use experimental PrivateSend mode with multiple mixing sessions per block.<br/>Note: You must use this feature carefully.<br/>Make sure you always have recent wallet (auto)backup in a safe place!", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        privateSendMultiSession->setText(QApplication::translate("OptionsDialog", "Enable PrivateSend &multi-session", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        spendZeroConfChange->setToolTip(QApplication::translate("OptionsDialog", "If you disable the spending of unconfirmed change, the change from a transaction<br/>cannot be used until that transaction has at least one confirmation.<br/>This also affects how your balance is computed.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        spendZeroConfChange->setText(QApplication::translate("OptionsDialog", "&Spend unconfirmed change", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        label->setToolTip(QApplication::translate("OptionsDialog", "This setting determines the amount of individual masternodes that an input will be anonymized through.<br/>More rounds of anonymization gives a higher degree of privacy, but also costs more in fees.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        label->setText(QApplication::translate("OptionsDialog", "PrivateSend rounds to use", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        label_2->setToolTip(QApplication::translate("OptionsDialog", "This amount acts as a threshold to turn off PrivateSend once it's reached.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("OptionsDialog", "Amount of Bitcoin Monster to keep anonymized", 0, QApplication::UnicodeUTF8));
        tabWidget->setTabText(tabWidget->indexOf(tabWallet), QApplication::translate("OptionsDialog", "W&allet", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the Bitcoin Monster Core client port on the router. This only works when your router supports UPnP and it is enabled.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the Bitcoin Monster network through a SOCKS5 proxy.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocksTor->setToolTip(QApplication::translate("OptionsDialog", "Connect to the Bitcoin Monster network through a separate SOCKS5 proxy for Tor hidden services.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting Bitcoin Monster Core.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
"https://www.transifex.com/projects/p/bitcoinmonster/", 0, QApplication::UnicodeUTF8));
        themeLabel->setText(QApplication::translate("OptionsDialog", "User Interface Theme:", 0, QApplication::UnicodeUTF8));
...
#endif // QT_NO_TOOLTIP
        digitsLabel->setText(QApplication::translate("OptionsDialog", "Decimal digits", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        thirdPartyTxUrlsLabel->setToolTip(QApplication::translate("OptionsDialog", "Third party URLs (e.g. a block explorer) that appear in the transactions tab as context menu items.<br/>%s in the URL is replaced by transaction hash. Multiple URLs are separated by vertical bar |.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        thirdPartyTxUrls->setToolTip(QApplication::translate("OptionsDialog", "Third party URLs (e.g. a block explorer) that appear in the transactions tab as context menu items.<br/>%s in the URL is replaced by transaction hash. Multiple URLs are separated by vertical bar |.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
