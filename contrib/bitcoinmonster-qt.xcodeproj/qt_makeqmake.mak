...
bitcoinmonster-qt.xcodeproj/project.pbxproj: bitcoinmonster-qt.pro  /usr/local/Qt4.8/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.8/mkspecs/common/unix.conf \
	...
	$(QMAKE) -o bitcoinmonster-qt.xcodeproj/project.pbxproj bitcoinmonster-qt.pro
