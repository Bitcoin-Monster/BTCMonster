...
This mechanism has been integrated into Bitcore-Node-BitcoinMonster which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/bitcoinmonstercoin/insight-api-bitcoinmonster#web-socket-api](https://github.com/bitcoinmonstercoin/insight-api-bitcoinmonster#web-socket-api) 
* API: [https://github.com/bitcoinmonstercoin/insight-api-bitcoinmonster#instantsend-transactions](https://github.com/bitcoinmonstercoin/insight-api-bitcoinmonster#instantsend-transactions) 
...
By default, the BitcoinMonster Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the BitcoinMonster Core daemon:
