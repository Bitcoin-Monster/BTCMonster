...
* Update translations, see [translation_process.md](https://github.com/banqcoin/bitcoinmonster/blob/master/doc/translation_process.md#syncing-with-transifex)
...
###Build and sign BitcoinMonster Core for Linux, Windows, and OS X:
...
Commit your signature to gitian.sigs:
  ...
  Wait for Windows/OS X detached signatures:
	...
	Detached signatures will then be committed to the [bitcoinmonster-detached-sigs](https://github.com/banqcoin/bitcoinmonster-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Release on BitcoinMonster forum: https://www.bitcoinmonster.org/forum/topic/official-announcements.54/

  - BitcoinMonster-development mailing list
