...
Coin2Fly Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Coin2Fly Core, where everyone uses
...
pay attention to for reviewers of Coin2Fly Core code.

General Coin2Fly Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Coin2Fly Core uses tinyformat, which is type safe. Leave them out to avoid confusion
