...
Only requiring some minor changes is banq.cpp.
...
Changes to banq.cpp
----------------------
banq.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
