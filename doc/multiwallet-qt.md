...
Only requiring some minor changes is bitcoinmonster.cpp.
...
Changes to bitcoinmonster.cpp
----------------------
bitcoinmonster.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
