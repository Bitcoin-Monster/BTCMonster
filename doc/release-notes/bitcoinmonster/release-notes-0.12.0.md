...
BitcoinMonster Core version 0.12.0 is now available from:

  https://bitcoinmonstercoin.io/downloads

Please report bugs using the issue tracker at github:

  https://github.com/bitcoinmonstercoin/bitcoinmonster/issues
...
backwards-compatible with pre-0.12 versions of BitcoinMonster Core or other software:
